...
# Uses a ResNet as the neural network model
...
class Learner():
    ...
    def learn(self):
        ...
        for epoch in range(0, self.args.epochs):
            ## Gradually changing the learning rate
